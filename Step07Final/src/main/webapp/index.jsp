...
<body>
	<div class="container">
		<c:choose>
			...
			<c:otherwise>
				<p>
					<a href="${pageContext.request.contextPath }/user/protected/info.jsp">${sessionDto.userName }</a>
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath }/post/list.jsp">글목록 보기</a></li>
