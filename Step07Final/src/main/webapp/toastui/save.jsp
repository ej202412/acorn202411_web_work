<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//Editor 로 입력한 html 형식의 문자열을 DB 에 저장했다가 필요 시 불러와서 그대로 html 형식으로 출력하면 된다
	String content=request.getParameter("content");
	//javascript 문자열의 구조를 망가트리지 않게 하기 위해
	String content2=content.replace("\"", "\\\""); //글 내용 중에 " 를 \" 로 변경하기
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<script>
        ...
        document.querySelector("#updateForm").addEventListener("submit", ()=>{
        	...
        	//폼에 이거 말고 다른 내용도 입력했다면 검증을 여기서 하고
        	
        	//폼 전송을 막고 싶으면(submit 이벤트의 기본 동작 막기)
