...
<%-- 
CommentDto 에 저장된 정보를 json 문자열 형식으로 응답
{"num":x, "writer":"xxx", "content":"xxx", "parentNum":x, ...}
gson 객체가 대신 수행
이 위치에 dto 에 있는 정보를 이용해서 json 문자열 형식으로 만들어줌 > json 문자열 출력 용이

list > array 등

응답한 json(댓글 정보) 이 comment 에 object 로 들어감
--%>
